...
const CONTENT = {
  ...
  skills: [
    { idx: '01', head: 'Edge AI / on-device inference', desc: 'Private LLMs, embeddings and vision running locally — no cloud dependency.', stack: ['LLaMA 3.1', 'Ollama', 'TensorRT-LLM', 'Vision'] },
    { idx: '02', head: 'Backend services', desc: 'Containerized stack with a Nextcloud headless backend, persistence and caching.', stack: ['Nextcloud', 'PostgreSQL', 'Redis', 'Python', 'TypeScript'] },
    { idx: '03', head: 'Hardware integration', desc: 'Edge boards, on-device routing and PCIe interconnects between SoC and AI module.', stack: ['Jetson', 'ARM SoC', 'OpenWrt', 'PCIe', 'Routing ASIC'] },
    { idx: '04', head: 'Frontend', desc: 'Native mobile and web dashboards interfacing with backend APIs.', stack: ['Flutter', 'React', 'Next.js', 'Vue / Nuxt'] },
    { idx: '05', head: 'Cloud / AWS', desc: 'Fault-tolerant serverless and containerized services from Amazon and Kanopy.', stack: ['Lambda', 'ECS', 'S3', 'Docker'] },
    { idx: '06', head: 'AI dev tooling', desc: 'Daily driver for shipping software at lean-team velocity.', stack: ['Claude Code + MCP', 'GitHub Copilot'] },
    { idx: '07', head: 'Languages', desc: 'Production work across web, systems and scripting languages.', stack: ['TS / JS', 'Python', 'C / C++ / C#', 'Java', 'PHP', 'SQL'] },
    { idx: '08', head: 'Practice', desc: 'Privacy-by-design, security audits, GDPR — Privacy Bar Raiser at Amazon.', stack: ['Privacy', 'Security', 'GDPR'] },
  ],
  projects: [
    { num: '01', title: 'Warp Lab — On-prem AI Appliance', year: '2026 — present', desc: 'A single appliance that replaces your router, NAS, and smart-home hub with one private box running everything locally — including an AI assistant that configures the network, manages files, and controls home automation. Working prototype today on a Pi 5 (OpenWrt) + Jetson + managed switch with a Realtek/MediaTek routing ASIC; next step is a custom PCB combining an ARM SoC, AI module, and a dedicated routing ASIC that physically separates WAN and LAN at the board level.', tags: ['Edge AI', 'LLaMA 3.1', 'Nextcloud', 'OpenWrt', 'Jetson'], ph: 'Warp Lab — on-prem AI appliance' },
